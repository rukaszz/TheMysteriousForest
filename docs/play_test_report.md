...
Package: TheMysteriousForest-v1.0.0-demo-linux-x86_64

Result: PASS

- run.sh による起動確認: PASS
- Stage 1〜4 通しプレイ: PASS
- Title から Result までの到達: PASS
...
当初の設計は追跡時，壁を無視するという方針であった．これはプレイヤーを焦らせることを目的としていたが，結果的には壁のめり込みによって敵を意図しない方法で無力化することになってしまった．Enemyも左右を連続で向くという奇妙な挙動となってしまうため，方針を改めた．
